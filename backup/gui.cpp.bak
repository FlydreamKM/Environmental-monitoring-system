...
extern "C" void gui_update_time(uint8_t hour, uint8_t minute, uint8_t second)
{
    ...
    /* 时 (16x26)  右栏 48px 宽居中: 80 + (48-32)/2 = 88 */
    if (hour != last_h) {
        snprintf(buf, sizeof(buf), "%02d", hour);
        ST7735_FillRectangleFast(LEFT_W, 10, 48, 26, ST7735_BLACK);
        ST7735_WriteString(88, 10, buf, Font_16x26, ST7735_WHITE, ST7735_BLACK);
        last_h = hour;
    }
    ...
    if (minute != last_m) {
        ...
        ST7735_FillRectangleFast(LEFT_W, 48, 48, 26, ST7735_BLACK);
        ST7735_WriteString(88, 48, buf, Font_16x26, ST7735_WHITE, ST7735_BLACK);
        last_m = minute;
    }
    ...
    if (second != last_s) {
        ...
        ST7735_FillRectangleFast(LEFT_W, 86, 48, 26, ST7735_BLACK);
        ST7735_WriteString(88, 86, buf, Font_16x26, ST7735_WHITE, ST7735_BLACK);
        last_s = second;
    }
}
